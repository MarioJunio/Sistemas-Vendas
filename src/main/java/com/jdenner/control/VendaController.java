...
import com.jdenner.view.component.BotaoRemoverItem;
import com.jdenner.view.component.ColunaData;
import com.jdenner.view.component.ColunaValor;
import com.jdenner.view.component.ColunaValorInteiro;
import com.jdenner.view.component.ComboCliente;
import com.jdenner.view.component.ComboProduto;
...
public class VendaController implements Initializable, Controller, Itens {
	...
	private void atualizarGrade(int pagina) {
		try {
			paginacao.setPageCount(
					(int) Math.ceil(((double) VendaDAO.quantidade(filtro.getText())) / QUANTIDADE_PAGINA));
	...
	private void atualizaValor() {
		Produto produto = (Produto) comboProduto.getItems().get(comboProduto.getSelectionModel().getSelectedIndex());
	...
	public void adicionarItem() throws ParseException {
		...
		item.setProduto((Produto) comboProduto.getItems().get(comboProduto.getSelectionModel().getSelectedIndex()));
